...
> {
  ...
  using MmaCore = typename DefaultMma::MmaCore;
  using Mma = typename DefaultMma::ThreadBlockMma;
  using IteratorThreadMapA = typename MmaCore::IteratorThreadMapA;

  using AccumulatorCombine = cutlass::gemm::threadblock::AccumulatorCombine<
      ElementAccumulator,
      cutlass::layout::ColumnMajor,
      Mma::FragmentC::kElements,
      IteratorThreadMapA::kElementsPerAccess,
      cutlass::MatrixShape<MmaCore::UnderlyingWarpThreadArrangement::kContiguous,
